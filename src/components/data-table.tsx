      ...
      <div className="flex items-center justify-between gap-3 text-sm">
        <div className="flex items-center gap-1">
          <button
            ...
            className="min-h-9 rounded-lg border border-border bg-surface px-3 py-1.5 text-sm font-semibold text-foreground transition hover:bg-surface-muted disabled:cursor-not-allowed disabled:opacity-50"
          >
            ← Sebelumnya
          </button>
          <button
        ...
        <select
          ...
          className="min-h-9 rounded-lg border border-border bg-surface px-2 py-1.5 text-sm text-foreground shadow-sm outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/10 cursor-pointer hover:border-primary"
        >
          {[5, 10, 20, 50].map((s) => (
